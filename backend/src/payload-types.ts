...
export interface Product {
  ...
  name: string;
  /**
   * Used in the URL (e.g., midnight-oud)
   */
  slug: string;
  description: string;
  fullDescription?: {
  ...
  price: number;
  /**
   * Original price if this item is on sale
   */
  ...
  notes?: {
    /**
     * e.g., Bergamot, Lemon, Saffron
     */
    top?: string | null;
    /**
     * e.g., Rose, Jasmine, Lavender
     */
    middle?: string | null;
    /**
     * e.g., Oud, Amber, Vanilla
     */
    base?: string | null;
  };
  /**
   * Show this product in featured/bestsellers section
   */
